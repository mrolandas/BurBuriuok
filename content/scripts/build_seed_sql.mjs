...
const MANUAL_ITEM_OVERRIDES = new Map(
  [
    ["zalingiai sprederiai", { nodeCode: "LBS-1-2-2", ordinal: 1 }],
    ["grotstiebis", { nodeCode: "LBS-1-2-2", ordinal: 6 }],
    ["forstiebis", { nodeCode: "LBS-1-2-2", ordinal: 6 }],
    ["bizanstiebis", { nodeCode: "LBS-1-2-2", ordinal: 6 }],
    ["kampai", { nodeCode: "LBS-1-2-4", ordinal: 13 }],
    ["krastines", { nodeCode: "LBS-1-2-4", ordinal: 13 }],
    ["denforto inkaras", { nodeCode: "LBS-1-3-1", ordinal: 12 }],
    ["pluginis inkaras", { nodeCode: "LBS-1-3-1", ordinal: 12 }],
    ["sudedamasis inkaras", { nodeCode: "LBS-1-3-1", ordinal: 12 }],
    ["grybo inkaras", { nodeCode: "LBS-1-3-1", ordinal: 12 }],
    ["sraigtinis inkaras", { nodeCode: "LBS-1-3-1", ordinal: 12 }],
    ["delta inkaras", { nodeCode: "LBS-1-3-1", ordinal: 12 }],
    ["dyzeliniai varikliai", { nodeCode: "LBS-1-3-3", ordinal: 1 }],
    ["benzininiai varikliai", { nodeCode: "LBS-1-3-3", ordinal: 1 }],
    ["elektriniai varikliai", { nodeCode: "LBS-1-3-3", ordinal: 1 }],
    ["markonine bermudine bure", { nodeCode: "LBS-1-2-4", ordinal: 4 }],
    ["dzonko bure", { nodeCode: "LBS-1-2-4", ordinal: 8 }],
    [
      "bermudinio groto kampai krastines",
      { nodeCode: "LBS-1-2-4", ordinal: 13 },
    ],
    ["inkaru tipai", { nodeCode: "LBS-1-3-1", ordinal: 12 }],
    ["sanitarines priemones", { nodeCode: "LBS-1-3-2", ordinal: 8 }],
    ["varikliu rusys ir paruosimas", { nodeCode: "LBS-1-3-3", ordinal: 1 }],
    ["vandens telkinio dugno gruntas", { nodeCode: "LBS-3-12-1", ordinal: 1 }],
    ["povandeniniai kliuviniai", { nodeCode: "LBS-3-12-1", ordinal: 2 }],
    ["meteorologiniai aspektai", { nodeCode: "LBS-3-12-1", ordinal: 5 }],
    ["hidrologiniai aspektai", { nodeCode: "LBS-3-12-1", ordinal: 6 }],
    ["teisiniai aspektai", { nodeCode: "LBS-3-12-1", ordinal: 7 }],
    ["urbanistiniai aspektai", { nodeCode: "LBS-3-12-1", ordinal: 8 }],
    ["vejo matuokliai", { nodeCode: "LBS-6-16", ordinal: 3 }],
    ["garsiniai signalai", { nodeCode: "LBS-8-8", ordinal: 1 }],
    ["velkantis laivas", { nodeCode: "LBS-9-3", ordinal: 4 }],
    ["minu traluotojas", { nodeCode: "LBS-9-3", ordinal: 10 }],

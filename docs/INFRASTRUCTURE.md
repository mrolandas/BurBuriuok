...
- Ship hierarchy management for sections/subsections/concepts in both backend (CRUD + reparenting rules) and admin UI (drag/drop, promote/demote controls with optimistic feedback).
